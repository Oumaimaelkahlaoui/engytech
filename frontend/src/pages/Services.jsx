...
const css = `
  ...
  .sv-hero__inner {
    ...
    animation:sv-up .9s cubic-bezier(.16,1,.3,1) .15s both;
  }
  .sv-eyebrow {
  ...
  .sv-hero__title {
    ...
    font-size:clamp(2.5rem,7vw,5rem); font-weight:500; line-height:1.05;
    letter-spacing:-.025em; color:#fff; margin-bottom:1.5rem;
  }
  .sv-hero__title em { font-style:italic; color:#2ab0b6; }
  .sv-hero__sub {
    font-size:clamp(.875rem,1.8vw,1rem); font-weight:300;
    color:rgba(255,255,255,.5); line-height:1.8; max-width:54ch; margin-inline:auto;
  ...
  .sv-intro__title {
    ...
    line-height:1.12; letter-spacing:-.02em; color:#0d1117;
    margin-bottom:1.5rem;
  }
  .sv-intro__title em { font-style:italic; color:#1B8A8F; }
  .sv-intro__text p {
    font-size:.9375rem; font-weight:300; color:#7a909e;
    line-height:1.9; margin-bottom:1.25rem; max-width:46ch;
  }
  .sv-intro__text p:last-of-type { margin-bottom:0; }

  /* right side — big stat blocks */
  .sv-intro__stats {
    display:grid; grid-template-columns:1fr 1fr; gap:2px;
    border-radius:12px; overflow:hidden;
  }
  .sv-intro__stat {
    background:#f4f6f9; padding:clamp(1.5rem,3vw,2.5rem) clamp(1.25rem,2vw,2rem);
    display:flex; flex-direction:column; gap:6px;
    transition:background .25s;
  }
  .sv-intro__stat:hover { background:#eaf0f4; }
  .sv-intro__stat strong {
    font-family:'Playfair Display',Georgia,serif;
  ...
  .sv-domains__header p {
    font-size:.9375rem; font-weight:300; color:rgba(255,255,255,.38);
    line-height:1.85; max-width:50ch; margin-top:1rem; margin-inline:auto;
  }
  .sv-domains__label {
    display:inline-block; font-size:.6875rem; font-weight:500;
  ...
  /* float grid — cards at different heights */
  .sv-domains__grid {
    display:grid;
  ...
  /* staggered vertical offsets for asymmetric look */
  ...
  .sv-domain:hover { animation-play-state:paused; }
  .sv-domain:hover { box-shadow:0 40px 80px rgba(0,0,0,.7); }
  ...
  .sv-domain__overlay {
    ...
    background:linear-gradient(to top,rgba(13,17,23,.92) 0%,rgba(13,17,23,.12) 55%,transparent 100%);
    transition:background .5s;
  }
  .sv-domain:hover .sv-domain__overlay {
    background:linear-gradient(to top,rgba(13,17,23,.97) 0%,rgba(13,17,23,.55) 60%,rgba(13,17,23,.1) 100%);
  }
  .sv-domain__line {
  ...
  .sv-domain__body {
    ...
    justify-content:flex-end; padding:clamp(1.25rem,2.5vw,1.75rem);
  }
  .sv-domain__tag {
    font-size:.58rem; font-weight:700; letter-spacing:.2em; text-transform:uppercase;
    color:#7DC242; margin-bottom:7px; display:block;
  ...
  .sv-domain__desc {
    ...
    color:rgba(255,255,255,.7); line-height:1.65; margin-top:9px;
    max-height:0; overflow:hidden; opacity:0; transform:translateY(12px);
    transition:max-height .5s cubic-bezier(.16,1,.3,1), opacity .4s .06s, transform .45s .06s;
  }
  .sv-domain:hover .sv-domain__desc { max-height:120px; opacity:1; transform:translateY(0); }

  /* ── APPROCHE (process visuel) ────────────────── */
  .sv-approach {
    background:#fff;
    padding:clamp(4rem,8vh,7rem) clamp(1.25rem,5vw,5rem);
  }
  ...
  .sv-approach__header p {
    font-size:.9375rem; font-weight:300; color:#7a909e;
    max-width:52ch; margin-inline:auto; margin-top:1rem; line-height:1.85;
  }
  .sv-approach__label {
    display:inline-block; font-size:.6875rem; font-weight:500;
    letter-spacing:.18em; text-transform:uppercase; color:#1B8A8F; margin-bottom:.75rem;
  ...
  .sv-steps::before {
    ...
    background:linear-gradient(90deg,transparent,#1B8A8F 20%,#7DC242 80%,transparent);
  }
  .sv-step {
    display:flex; flex-direction:column; align-items:center; text-align:center;
    padding:0 clamp(.75rem,2vw,1.5rem); position:relative; z-index:1;
  }
  .sv-step__circle {
    width:72px; height:72px; border-radius:50%;
    background:#f4f6f9; border:1.5px solid #dde5ea;
  ...
  .sv-step__num {
    ...
    color:#7DC242; background:#fff; padding:2px 6px; border-radius:2px;
  ...
  .sv-engage__header p {
    font-size:.9375rem; font-weight:300; color:#7a909e;
    max-width:50ch; margin-inline:auto; margin-top:1rem; line-height:1.85;
  }
  .sv-engage__title {
    font-family:'Playfair Display',Georgia,serif;
    font-size:clamp(1.75rem,4vw,3.25rem); font-weight:500;
  ...
  .sv-engage__item {
    background:#fff; padding:clamp(1.75rem,3vw,2.5rem) clamp(1.25rem,2.5vw,2rem);
    display:flex; flex-direction:column; gap:1rem; border-radius:2px;
    position:relative; overflow:hidden;
    transition:transform .35s cubic-bezier(.16,1,.3,1), box-shadow .35s;
  }
  .sv-engage__item::after {
  ...
  .sv-engage__icon {
    ...
    background:linear-gradient(135deg,rgba(43,57,144,.07),rgba(27,138,143,.09));
    display:flex; align-items:center; justify-content:center;
  ...
  .sv-engage__item h3 {
    font-family:'Playfair Display',Georgia,serif;
    font-size:clamp(1rem,1.8vw,1.2rem); font-weight:500; color:#0d1117; line-height:1.25;
  }
  ...
  .sv-cta p {
    font-size:.9375rem; font-weight:300; color:rgba(255,255,255,.5);
    line-height:1.75; margin-bottom:2.5rem; max-width:44ch; margin-inline:auto;
  }
  ...
  .btn {
    ...
    border:none; border-radius:4px; white-space:nowrap; text-decoration:none; cursor:pointer;
  ...
  @media (max-width:1024px) {
    .sv-intro__inner { grid-template-columns:1fr; gap:3rem; }
    .sv-intro__stats { grid-template-columns:repeat(4,1fr); }
    .sv-domains__grid { grid-template-columns:repeat(2,1fr); gap:14px; }
    .sv-domain:nth-child(1),.sv-domain:nth-child(2),.sv-domain:nth-child(3),.sv-domain:nth-child(4) { margin-bottom:0; }
    .sv-steps { grid-template-columns:repeat(2,1fr); gap:clamp(2rem,4vw,3rem); }
    .sv-steps::before { display:none; }
    .sv-engage__grid { grid-template-columns:repeat(2,1fr); }
  }
  @media (max-width:768px) {
    .sv-intro__stats { grid-template-columns:repeat(2,1fr); }
    .sv-domains__grid { grid-template-columns:repeat(2,1fr); gap:12px; }
    .sv-domain { aspect-ratio:3/4; }
    .sv-engage__grid { grid-template-columns:1fr; }
  }
  @media (max-width:640px) {
    .sv-steps { grid-template-columns:1fr; }
    .sv-hero__actions,.sv-cta__actions { flex-direction:column; align-items:stretch; }
    .sv-hero__actions .btn,.sv-cta__actions .btn { width:100%; justify-content:center; }
  }
`;

/* ── SVG ICONS ─────────────────────────────────── */
const IcoRuler  = ({s="#1B8A8F"}) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={s} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M11 5l3 3M14 8l3 3M8 11l3 3"/>
  </svg>
);
const IcoShield = ({s="#1B8A8F"}) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={s} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
    <path d="M9 12l2 2 4-4"/>
  </svg>
);
const IcoClock  = ({s="#1B8A8F"}) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={s} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="12" cy="12" r="10"/>
    <polyline points="12 6 12 12 16 14"/>
  </svg>
);
const IcoUsers  = ({s="#1B8A8F"}) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={s} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
/* step icons */
const IcoMsg    = ({s="#1B8A8F"}) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={s} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/>
  </svg>
);
const IcoSearch = ({s="#1B8A8F"}) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={s} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <circle cx="11" cy="11" r="8"/>
    <line x1="21" y1="21" x2="16.65" y2="16.65"/>
  </svg>
);
const IcoPencil = ({s="#1B8A8F"}) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={s} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 20h9"/>
    <path d="M16.5 3.5a2.121 2.121 0 013 3L7 19l-4 1 1-4L16.5 3.5z"/>
  </svg>
);
const IcoCheck  = ({s="#1B8A8F"}) => (
  <svg viewBox="0 0 24 24" fill="none" stroke={s} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
const engagements = [
  { Icon:IcoShield, title:"Rigueur technique", desc:"Chaque étude est vérifiée et validée selon les normes les plus exigeantes avant remise au client." },
  { Icon:IcoClock,  title:"Respect des délais", desc:"Planning contractuel tenu grâce à une organisation rigoureuse et des outils de gestion éprouvés." },
  { Icon:IcoUsers,  title:"Équipe dédiée", desc:"Un interlocuteur unique par projet, disponible et réactif à chaque étape." },
  { Icon:IcoChart,  title:"Transparence totale", desc:"Reporting régulier, communication claire et accès permanent à l'avancement du projet." },
  { Icon:IcoRuler,  title:"Précision & qualité", desc:"Zéro compromis sur la qualité des livrables — plans, notes de calcul et rapports au standard le plus élevé." },
  { Icon:IcoLeaf,   title:"Approche durable", desc:"L'environnement intégré dès la phase conception pour des ouvrages résilients et responsables." },
];
      ...
      <div className="sv">
        ...
        <section className="sv-hero">
          <div className="sv-hero__inner">
            ...
            <div className="sv-hero__actions">
              <button className="btn btn--accent" onClick={() => navigate("/devis")}>
        ...
        <section className="sv-intro">
          <div className="sv-intro__inner">
            <div className="sv-intro__text" data-reveal>
              ...
              <p>
                Notre équipe pluridisciplinaire maîtrise l'ensemble des spécialités de
                l'ingénierie du bâtiment : structure, fluides, énergie, VRD et numérique.
                Nous proposons des prestations à la carte ou des missions complètes selon vos besoins.
              </p>
              <br />
              <button className="btn btn--accent" onClick={() => navigate("/devis")}>
                Découvrir nos 10 prestations →
              </button>
            </div>
            <div className="sv-intro__stats" data-reveal>
              {[
                { num:"10+",  label:"Types de prestations" },
                { num:"280+", label:"Projets livrés" },
                { num:"12+",  label:"Années d'expérience" },
                { num:"98%",  label:"Taux de satisfaction" },
              ].map(({ num, label }) => (
                <div className="sv-intro__stat" key={label}>
                  <strong>{num}</strong>
                  <span>{label}</span>
                </div>
              ))}
        ...
        <section className="sv-domains">
          <div className="sv-domains__inner">
            <div className="sv-domains__header" data-reveal>
              ...
              <p>
                Quatre pôles majeurs qui structurent notre expertise et couvrent
            ...
            <div className="sv-domains__grid">
              {domains.map(({ tag, title, desc, img }) => (
                <div className="sv-domain" key={title} data-reveal>
                  ...
                  <div className="sv-domain__overlay" />
                  <div className="sv-domain__line" />
                  <div className="sv-domain__body">
                    <span className="sv-domain__tag">{tag}</span>
        ...
        <section className="sv-approach">
          <div className="sv-approach__inner">
            <div className="sv-approach__header" data-reveal>
              ...
              <p>De la prise de contact à la livraison, une méthode éprouvée qui garantit la réussite de chaque projet.</p>
            </div>
            <div className="sv-steps">
              {steps.map(({ Icon, title, desc }, i) => (
                <div className="sv-step" key={title} data-reveal>
                  <div className="sv-step__circle">
                    <span className="sv-step__num">0{i + 1}</span>
                    <Icon s="#1B8A8F" />
                  </div>
                  <h4>{title}</h4>
                  <p>{desc}</p>
        ...
        <section className="sv-engage">
          <div className="sv-engage__inner">
            <div className="sv-engage__header" data-reveal>
              ...
              <p>Des valeurs concrètes qui guident chacune de nos interventions et définissent notre relation client.</p>
            </div>
        ...
        <section className="sv-cta">
          <div className="sv-cta__inner">
            ...
            <p>
              Consultez nos 10 prestations détaillées et demandez un devis
              personnalisé sous 48h.
            </p>
            <div className="sv-cta__actions">
              <button className="btn btn--light" onClick={() => navigate("/devis")}>
