...
export default function SuiviContrôle() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const { data: devisData, error: devisError } = await supabase.from("devis_types").select("id").eq("nom_devis", "Suivi et contrôle technique des travaux").single()
        ...
        <div style={S.hero}>
          ...
          <div style={S.heroInner}>
            <div>
              ...
              <h1 style={S.heroH1}>Suivi & <span style={S.heroItalic}>Contrôle Technique</span></h1>
              <p style={S.heroSub}>Contrôle et suivi technique des travaux pour garantir la conformité du chantier avec les normes et les études.</p>
            </div>
