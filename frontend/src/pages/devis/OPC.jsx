  ...
  async function handleSubmit(e) {
    ...
    try {
      const { data: devisData, error: devisError } = await supabase
        .from("devis_types")
        .select("id")
        .eq("nom_devis", "OPC – Ordonnancement, Pilotage et Coordination")
        .single()
      ...
      <div style={S.page}>
        ...
        <div style={S.hero}>
          ...
          <div style={S.heroInner}>
           ...
           <h1 style={S.heroH1}>
  Mission <span style={S.heroItalic}>OPC</span>
</h1>
           <p style={S.heroSub}>
  Ordonnancement, Pilotage et Coordination des travaux
  pour assurer le respect des délais, du budget et
