  ...
  async function handleSubmit(e) {
    ...
    try {
      const { data: devisData, error: devisError } = await supabase
        .from("devis_types")
        .select("id")
        .eq("nom_devis", "Étude d’Efficacité Énergétique du Bâtiment")
        .single()
      ...
      <div style={S.page}>
        ...
        <div style={S.hero}>
          ...
          <div style={S.heroInner}>
           ...
           <h1 style={S.heroH1}>
            Étude d’<span style={S.heroItalic}>Efficacité Énergétique</span>
            </h1>

            <p style={S.heroSub}>
            Analyse de la performance énergétique du bâtiment
            pour réduire la consommation d’énergie et améliorer
