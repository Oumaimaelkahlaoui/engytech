  ...
  async function handleSubmit(e) {
    ...
    try {
      const { data: devisData, error: devisError } = await supabase
        .from("devis_types")
        .select("id")
        .eq("nom_devis", "Expertise technique et diagnostic des ouvrages")
        .single()
      ...
      <div style={S.page}>
        ...
        <div style={S.hero}>
          ...
          <div style={S.heroInner}>
            ...
            <h1 style={S.heroH1}>
            Expertise <span style={S.heroItalic}>Technique</span>
            </h1>

            <p style={S.heroSub}>
            Diagnostic des pathologies des ouvrages, analyse structurelle
            et recommandations techniques pour assurer la sécurité
