  ...
  async function handleSubmit(e) {
    ...
    try {
      const { data: devisData, error: devisError } = await supabase
        ...
        .eq("nom_devis", "Notice de sécurité incendie").single()
        ...
        <div style={S.hero}>
          ...
          <div style={S.heroInner}>
            <div>
              ...
              <h1 style={S.heroH1}>Notice <span style={S.heroItalic}>Sécurité Incendie</span></h1>
              <p style={S.heroSub}>Élaboration de la notice de sécurité incendie pour les projets de construction afin d'assurer la conformité avec la réglementation et la sécurité des occupants.</p>
            </div>
