...
export default function NoteCalculs() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      const { data: devisData, error: devisError } = await supabase.from("devis_types").select("id").eq("nom_devis", "Note calculs").single()
        ...
        <div style={S.hero}>
          ...
          <div style={S.heroInner}>
            <div>
              ...
              <h1 style={S.heroH1}>Note de <span style={S.heroItalic}>Calculs</span></h1>
              <p style={S.heroSub}>Élaboration des notes de calcul nécessaires pour vérifier la stabilité et la conformité des structures du projet.</p>
            </div>
