...
const S = {
  ...
  heroEye: {
    ...
    textTransform: "uppercase", color: "#4ecda4", marginBottom: 14,
  },
  ...
  heroH1: {
    ...
    lineHeight: 1.0, letterSpacing: "-0.025em", color: "#fff", margin: "0 0 10px",
  },
  heroItalic: { fontStyle: "italic", color: "#4ecda4" },
  heroSub: {
    fontSize: "clamp(0.8125rem,1.3vw,0.9rem)", fontWeight: 300,
    color: "rgba(255,255,255,0.5)", maxWidth: "44ch", lineHeight: 1.7, margin: 0,
  },
  heroBadge: {
    display: "inline-flex", alignItems: "center", gap: 8,
    padding: "10px 20px", background: "rgba(58,184,122,0.12)",
    border: "1px solid rgba(58,184,122,0.3)", borderRadius: 100,
    fontSize: "0.625rem", fontWeight: 600, letterSpacing: "0.18em",
    textTransform: "uppercase", color: "#4ecda4", alignSelf: "flex-start", marginTop: 8,
  },
  main: {
    maxWidth: 1100, margin: "0 auto",
    padding: "clamp(2rem,4vw,3.5rem) clamp(1.5rem,6vw,5rem) clamp(3rem,6vw,5rem)",
    display: "grid", gridTemplateColumns: "1fr 340px",
    gap: "clamp(2rem,4vw,3.5rem)", alignItems: "start",
  },
  formCard: {
  ...
  formHeader: {
    padding: "20px 28px 18px", borderBottom: "1px solid #edf1f8",
    display: "flex", alignItems: "center", gap: 12,
  },
  formHeaderDot: {
    width: 8, height: 8, borderRadius: "50%",
    background: "linear-gradient(135deg, #2a7fa5, #4ecda4)", flexShrink: 0,
  },
  formHeaderTitle: {
    fontFamily: "'Playfair Display', Georgia, serif",
    fontSize: "1rem", fontWeight: 500, color: "#0e1c3a", margin: 0, letterSpacing: "-0.01em",
  },
  ...
  label: {
    ...
    textTransform: "uppercase", color: "#7a8faa",
  },
  input: {
    fontFamily: "'Outfit', system-ui, sans-serif",
    fontSize: "0.875rem", fontWeight: 300, color: "#0e1c3a",
    background: "#f8fafd", border: "1.5px solid #dde5f0",
    borderRadius: 8, padding: "11px 14px", outline: "none", width: "100%",
  ...
  dividerText: {
    fontSize: "0.625rem", fontWeight: 500, letterSpacing: "0.16em",
    textTransform: "uppercase", color: "#c9d4e8", whiteSpace: "nowrap",
  },
  radioGroup: { display: "flex", gap: 10, flexWrap: "wrap" },
  fileZone: {
    border: "1.5px dashed #c9d4e8", borderRadius: 10, padding: "20px 16px",
    textAlign: "center", cursor: "pointer", background: "#f8fafd",
  ...
  stepsCard: {
    background: "#0e1c3a", borderRadius: 14,
    boxShadow: "0 4px 24px rgba(14,28,58,0.2)", overflow: "hidden",
  },
  stepsHeader: { padding: "16px 20px", borderBottom: "1px solid rgba(255,255,255,0.07)" },
  stepsTitle: {
    fontFamily: "'Playfair Display', Georgia, serif",
    fontSize: "0.9375rem", fontWeight: 400, color: "#fff", margin: 0,
  },
  ...
  stepDesc: {
    ...
    color: "rgba(255,255,255,0.38)", lineHeight: 1.55, margin: 0,
  },
};
...
export default function ClientForm() {
  ...
  const resetForm = () => {
    ...
    setTypeProjet(''); setSurface(''); setFiles([]); setTypeStructure('');
  }
  ...
  async function handleSubmit(e) {
    ...
    try {
      const { data: devisData, error: devisError } = await supabase
        ...
        .eq("nom_devis", "Étude de structure (béton armé / métallique)").single()
      if (devisError) { console.log("ERREUR TYPE DEVIS:", devisError); return }

      const { data: newDemande, error: insertError } = await supabase
        .from('demandes_devis')
        .insert([{ devis_type_id: devisData.id, nomcompelt, email, telephone, type_projet: typeProjet, surface, type_structure: typeStructure }])
        .select()
  ...
  const SuccessPage = () => (
    <div style={{
      ...
      <div style={{
        ...
        background: "linear-gradient(135deg, #2a7fa5, #3ab87a)",
        display: "flex", alignItems: "center", justifyContent: "center",
        boxShadow: "0 12px 40px rgba(58,184,122,0.4)",
        animation: "cf-pop .55s cubic-bezier(.16,1,.3,1) both",
      }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10, maxWidth: "44ch", animation: "cf-fadein .6s .15s both" }}>
        <h3 style={{
          ...
          color: "#0e1c3a", letterSpacing: "-0.02em", margin: 0, lineHeight: 1.15,
        }}>
        ...
        <p style={{ fontSize: "0.9rem", fontWeight: 300, color: "#7a8faa", lineHeight: 1.8, margin: 0 }}>
          Notre équipe a bien reçu votre demande de devis et vous contactera
          sous <strong style={{ color: "#0e1c3a", fontWeight: 500 }}>24 heures ouvrées</strong>.
        </p>
      </div>
      ...
      <div style={{
        ...
        width: "100%", animation: "cf-fadein .6s .25s both",
      }}>
        {[
          ...
          <div key={label} style={{
            ...
            borderRadius: 10, border: "1px solid #edf1f8",
      ...
      {/* Prochaines étapes */}
      <div style={{
        width: "100%", background: "#0e1c3a", borderRadius: 12,
        padding: "20px 24px", textAlign: "left",
        animation: "cf-fadein .6s .35s both",
      }}>
        <p style={{ fontSize: "0.625rem", fontWeight: 600, letterSpacing: "0.16em", textTransform: "uppercase", color: "#4ecda4", margin: "0 0 14px" }}>
          Prochaines étapes
        </p>
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            "Notre équipe analyse votre demande sous 24h",
            "Vous recevez un devis personnalisé par email",
            "Validation et démarrage des études",
          ].map((step, i) => (
            <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
              <div style={{
                ...
                border: "1.5px solid rgba(78,205,164,0.4)",
                display: "flex", alignItems: "center", justifyContent: "center",
                fontSize: "0.5rem", fontWeight: 700, color: "#4ecda4",
              }}>0{i + 2}</div>
      ...
      <div style={{ display: "flex", gap: 12, flexWrap: "wrap", justifyContent: "center", animation: "cf-fadein .6s .45s both" }}>
        <button onClick={resetForm} style={{
          ...
          border: "1.5px solid #dde5f0", background: "#fff",
          color: "#7a8faa", fontFamily: "'Outfit',system-ui,sans-serif",
        ...
        <div style={S.hero}>
          ...
          <div style={S.heroInner}>
            <div>
              ...
              <h1 style={S.heroH1}>
                Étude de <span style={S.heroItalic}>structure</span>
              </h1>
              <p style={S.heroSub}>
                Béton armé ou métallique — calculs de stabilité, plans coffrage et ferraillage aux normes en vigueur.
              </p>
            </div>
                ...
                <form onSubmit={handleSubmit} style={S.formBody}>
                  ...
                  <div className="cf-row" style={S.fieldRow}>
                    <div style={S.fieldCol}>
                      ...
                      <input value={nomcompelt} onChange={e => setNomCompelt(e.target.value)}
                        placeholder="Ex : Mohamed Alami" required
                        style={inputStyle("nom")} onFocus={() => setFocusedField("nom")} onBlur={() => setFocusedField(null)} />
                    </div>
                    <div style={S.fieldCol}>
                      <label style={S.label}>Adresse email *</label>
                      <input value={email} onChange={e => setEmail(e.target.value)}
                        placeholder="exemple@email.com" type="email" required
                  ...
                  <div className="cf-row" style={S.fieldRow}>
                    <div style={S.fieldCol}>
                      ...
                      <input value={telephone} onChange={e => setTelephone(e.target.value)}
                        ...
                        style={inputStyle("tel")} onFocus={() => setFocusedField("tel")} onBlur={() => setFocusedField(null)} />
                    </div>
                    <div style={S.fieldCol}>
                      <label style={S.label}>Surface (m²) *</label>
                      <input value={surface} onChange={e => setSurface(e.target.value)}
                        placeholder="Ex : 250" type="number" required
                        style={inputStyle("surface")} onFocus={() => setFocusedField("surface")} onBlur={() => setFocusedField(null)} />
                    </div>
                  </div>
                  ...
                  <div style={S.fieldCol}>
                    ...
                    <input value={typeProjet} onChange={e => setTypeProjet(e.target.value)}
                      placeholder="Ex : Villa R+2, Immeuble collectif, Entrepôt..." required
                      style={inputStyle("projet")} onFocus={() => setFocusedField("projet")} onBlur={() => setFocusedField(null)} />
                  </div>

                  {/* Divider */}
                  <div style={S.divider}><div style={S.dividerLine} /><span style={S.dividerText}>Type de structure</span><div style={S.dividerLine} /></div>

                  {/* Radio */}
                  <div style={S.fieldCol}>
                    <div style={S.radioGroup}>
                      {RADIO_OPTIONS.map((opt) => {
                        const isSelected = typeStructure === opt.value;
                        return (
                          <label key={opt.value} style={{
                            ...
                            <span style={{
                              ...
                              background: isSelected ? "radial-gradient(circle at center, #2a7fa5 45%, transparent 46%)" : "#fff",
                              flexShrink: 0, display: "inline-block", transition: "border-color 0.2s, background 0.2s",
                            }} />
                            <input type="radio" name="typeStructure" value={opt.value}
                              checked={isSelected} onChange={e => setTypeStructure(e.target.value)}
                              style={{ display: "none" }} />
                            {opt.label}
                          </label>
                        );
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 6, width: "100%" }}>
                          {files.map((file, i) => (
                            <div key={i} style={{
                              ...
                              background: "rgba(58,184,122,0.08)", border: "1px solid rgba(58,184,122,0.25)", borderRadius: 6,
                            }}>
                              <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
                                <span style={{ fontSize: "0.9rem", flexShrink: 0 }}>📄</span>
                                <span style={{ fontSize: "0.75rem", fontWeight: 400, color: "#0e1c3a", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
                                  {file.name}
                                </span>
                              </div>
                              <span style={{ fontSize: "0.6rem", color: "#9aafc4", flexShrink: 0 }}>
